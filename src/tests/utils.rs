...
use crate::AvlTree;
pub fn key_value(tuple: (i32, i32, Option<i32>)) -> (i32, i32) {
...
pub fn assert_tree_contains(tree: &AvlTree<i32, i32>, expected_values: Vec<(i32, i32)>) {
    assert_tree_range_contains(tree, i32::MIN..i32::MAX, expected_values);
}
pub fn assert_tree_range_contains<R: RangeBounds<i32>>(
...
pub fn assert_tree_range_back_contains<R: RangeBounds<i32>>(
    tree: &AvlTree<i32, i32>,
    range: R,
    expected_values: Vec<(i32, i32)>,
) {
